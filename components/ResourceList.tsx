        ...
        <AnimatePresence mode="popLayout">
          {resources.length === 0 ? (
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="text-center py-12 px-6 border border-dashed border-white/5 rounded-xl m-2 bg-white/[0.01]"
            >
            ...
            resources.map((resource) => (
              <motion.div 
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="group flex items-center gap-4 p-3 rounded-xl hover:bg-white/[0.03] border border-transparent hover:border-white/5 transition-all duration-200"
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-xs font-medium text-gray-300 truncate group-hover:text-gray-100 transition-colors">
                    {resource.title}
                  </h3>
